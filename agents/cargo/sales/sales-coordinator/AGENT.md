...
- `/knowledge/external/dossiers/persons/DOSSIER-COLE-GORDON.md` - Operações de vendas
- `/knowledge/external/dossiers/THEMES/DOSSIER-09-GESTAO.md` - Sales Management
- `/knowledge/external/sources/cole-gordon/09-GESTAO.md` - Admin & Ops
