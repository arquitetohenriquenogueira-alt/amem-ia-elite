...
|---------|------|------------|
| `/knowledge/external/dossiers/persons/DOSSIER-COLE-GORDON.md` | Tudo de Cole Gordon | ALTA |
| `/knowledge/external/dossiers/THEMES/DOSSIER-09-GESTAO.md` | Sales Management | ALTA |
| `/knowledge/external/dossiers/THEMES/DOSSIER-06-FUNIL-APLICACAO.md` | Application Grading | ALTA |
| `/knowledge/external/sources/cole-gordon/09-GESTAO.md` | Admin & Ops | ALTA |
| `/knowledge/external/sources/cole-gordon/06-FUNIL-APLICACAO.md` | Lead Attribution | ALTA |
